...
var Bezier = function (t) {
  ...
  ! function () {
    ...
    l.getUtils = v, l.prototype = {
      ...
      toSVG: function (t) {
        ...
        for (var n = this.points, r = n[0].x, i = n[0].y, e = ["M", r, i, 2 === this.order ? "Q" : "C"], o = 1, s = n.length; o < s; o++) e.push(n[o].x), e.push(n[o].y);
        return e.join(" ")
      },
      update: function () {
        this.dpoints = [];
        for (var t = this.points, n = t.length, r = n - 1; n > 1; n--, r--) {
          for (var i, e = [], o = 0; o < r; o++) i = {
            x: r * (t[o + 1].x - t[o].x),
            y: r * (t[o + 1].y - t[o].y)
      ...
      project: function (t) {
        ...
        var a, s, f, c, h = (o - 1) / r,
          x = (o + 1) / r,
          p = .1 / r;
        for (e += 1, s = h, a = s; s < x + p; s += p) f = this.compute(s), c = y.dist(t, f), c < e && (e = c, a = s);
      ...
      compute: function (t) {
        ...
        for (var c = JSON.parse(JSON.stringify(this.points)); c.length > 1;) {
          for (var h = 0; h < c.length - 1; h++) c[h] = {
      ...
      raise: function () {
        for (var t, n, r, i = this.points, e = [i[0]], o = i.length, t = 1; t < o; t++) n = i[t], r = i[t - 1], e[t] = {
          x: (o - t) / o * n.x + t / o * r.x,
          y: (o - t) / o * n.y + t / o * r.y
        };
      ...
      hull: function (t) {
        ...
        for (e[o++] = r[0], e[o++] = r[1], e[o++] = r[2], 3 === this.order && (e[o++] = r[3]); r.length > 1;) {
          for (i = [], s = 0, u = r.length - 1; s < u; s++) n = y.lerp(t, r[s], r[s + 1]), e[o++] = n, i.push(n);
          r = i
        }
        return e
      },
      ...
      extrema: function () {
        ...
        }.bind(this)), e = e.sort(y.numberSort).filter(function (t, n) {
      ...
      reduce: function () {
        ...
        for (a.indexOf(0) === -1 && (a = [0].concat(a)), a.indexOf(1) === -1 && a.push(1), r = a[0], t = 1; t < a.length; t++) i = a[t], n = this.split(r, i), n._t1 = r, n._t2 = i, s.push(n), r = i;
          ...
          for (r = 0, i = 0; i <= 1;)
            for (i = r + o; i <= 1 + o; i += o)
              if (n = t.split(r, i), !n.simple()) {
                ...
                break
              } r < 1 && (n = t.split(r, 1), n._t1 = y.map(r, 0, 1, t._t1, t._t2), n._t2 = t._t2, u.push(n))
        }), u
      },
      scale: function (t) {
        var n = this.order,
      ...
      outline: function (t, n, r, i) {
        ...
        s.forEach(function (o) {
          _ = o.length(), x ? (a.push(o.scale(e(t, r, h, c, _))), f.push(o.scale(e(-n, -i, h, c, _)))) : (a.push(o.scale(t)), f.push(o.scale(-n))), c += _
        }), f = f.map(function (t) {
      ...
      selfintersects: function (t) {
        var n, r, i, e, o = this.reduce(),
          s = o.length - 2,
          u = [];
        for (n = 0; n < s; n++) i = o.slice(n, n + 1), e = o.slice(n + 2), r = this.curveintersects(i, e, t), u = u.concat(r);
        return u
      },
      ...
      _iterate: function (t, n) {
        ...
        do {
          ...
          var o, s, f, c, h, x = this.get(i),
            ...
            m = 0;
          do {
            l = p, c = f, v = (i + e) / 2, m++, o = this.get(v), s = this.get(e), f = y.getccenter(x, o, s), f.interval = {
              start: i,
              end: e
            };
    ...
    var n = Math.abs,
      ...
      v = {
        ...
        getminmax: function (t, n, r) {
          ...
          for (var u = 0, a = r.length; u < a; u++) i = r[u], e = t.get(i), e[n] < o && (o = e[n]), e[n] > s && (s = e[n]);
          return {
            min: o,
            mid: (o + s) / 2,
            max: s,
        ...
        roots: function (t, n) {
          ...
          if (0 === N) return g = T < 0 ? f(-T) : -f(T), z = 2 * g - a / 3, b = -g - a / 3, [z, b].filter(s);
          var G = u(N);
        ...
        getccenter: function (t, n, r) {
          var o, u = n.x - t.x,
            ...
            T = s(n.y - M.y, n.x - M.x),
            N = s(r.y - M.y, r.x - M.x);
          return O < N ? ((O > T || T > N) && (O += h), O > N && (o = N, N = O, O = o)) : N < T && T < O ? (o = N, N = O, O = o) : N += h, M.s = O, M.e = N, M.r = k, M
        },
  ...
  ! function () {
    ...
    i.prototype = {
      ...
      bbox: function t() {
        for (var r = this.curves, t = r[0].bbox(), i = 1; i < r.length; i++) n.expandbox(t, r[i].bbox());
        return t
      },
      offset: function t(n) {
        var t = [];
